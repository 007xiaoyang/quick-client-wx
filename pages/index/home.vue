...
<template>
	<view class="fulled-height">
		<mescroll-uni :fixed="false" ref="mescrollRef" :down="downOption" :up="upOption" @init="mescrollInit"
			@down="downCallback" @up="upCallback" @scroll="scroll">
						...
						<view class="round-3 shadow-2 overflow white">
							...
							<block v-if="hdata.item.model=='swiper'">
								<view :style="{width:hdata.width+'px',height:hdata.item.height+'px'}">
									<tm-swiper dot-model="rect" :indicator-dots="true"
										:height="(hdata.item.height+'px')"
					...
					<template v-slot:right="{hdata}">
						...
						<view class="round-3 shadow-2 overflow white">
							...
							<block v-if="hdata.item.model=='swiper'">
								...
								<view :style="{width:hdata.item.width+'px',height:hdata.item.height+'px'}">
									<tm-swiper dot-model="round" :indicator-dots="true"
										:height="(hdata.item.height+'px')"
										:list=" [ 'https://picsum.photos/300?jv=3','https://picsum.photos/300?jv=3' ] ">
									</tm-swiper>
								</view>
